            ...
            typeof self !== 'undefined' ? self : this, function () {
                ...
                class GPayments3DS {
                    ...
                    resetTransactionState() {
                        this.log('Resetting transaction state for new authentication attempt');
                        ...
                        // Generate new request ID for this attempt
                        this.requestId = this.generateRequestId();
                    }

                    async authenticate(cardData, additionalData = {}) {
                        try {
                            // Reset transaction state for new authentication attempt
